-- Baseline migration: full schema as of the introduction of the migrations
-- system. This is the source of truth for a fresh database; existing
-- databases that predate migrations get this recorded as applied without
-- being executed (see persistence/migrations.py::_schema_already_exists).
--
-- RULE FOR FUTURE CHANGES: never edit this file. Add a new NNNN_*.sql
-- migration, and mirror the change into persistence/schema.sql so it
-- always reflects the latest full schema.
